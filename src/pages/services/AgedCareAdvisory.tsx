...
const AgedCareAdvisory = () => {
  ...
  const differentiators = ["Former hospital in-house legal counsel", "Dual-qualified (Australia, NZ, Canada)", "Fluent in clinical documentation and aged care standards", "We explain regulatory risk in plain English — no courtroom jargon", "We focus on preventing harm and keeping your facility running smoothly"];
