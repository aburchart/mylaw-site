      ...
      <div className="container">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            {/* Placeholder for logos/recognition */}
            <div className="h-12 w-32 bg-slate rounded flex items-center justify-center">
              <span className="text-sm font-medium">Queensland Law Society</span>
            </div>
            <div className="h-12 w-32 bg-slate rounded flex items-center justify-center">
              <span className="text-sm font-medium">Healthcare Excellence</span>
            </div>
            <div className="h-12 w-32 bg-slate rounded flex items-center justify-center">
              <span className="text-sm font-medium">Compliance Institute</span>
            </div>
          </div>
        </div>
      </div>
