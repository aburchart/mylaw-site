...
import { CheckCircle, Shield, AlertTriangle, Users, FileCheck, Clock, Phone } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description:
    "Expert aged care compliance advisory for Queensland providers. Stay ACQSC-accredited, prepare for audits, and protect residents with proactive legal support from Brisbane.",
};

export default function AgedCareAdvisory() {
  ...
  const differentiators = [
    ...
    "We explain regulatory risk in plain English — no courtroom jargon",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 bg-primary text-primary-foreground">
        <div className="container max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Let's Make Your Next Audit Boring (In a Good Way)</h2>
