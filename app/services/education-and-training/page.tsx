...
import { Users, Stethoscope, Shield, BookOpen, Clock, CheckCircle2 } from "lucide-react";
import { BookingCTAButton } from "@/components/ui/booking-cta-button";

export const metadata: Metadata = {
  title: "Education & Training",
  description:
    "Compliance training and clinical documentation education for aged care, NDIS, and healthcare teams across Queensland. In-person Brisbane or virtual sessions tailored to your facility.",
};

export default function ClinicalDocumentationTraining() {
  const targetAudience = [
    { icon: Stethoscope, text: "Registered Nurses (RNs)" },
    { icon: Users, text: "Allied Health Professionals" },
    { icon: Shield, text: "Aged Care & NDIS Support Workers" },
    { icon: BookOpen, text: "Practice Managers & Compliance Leads" },
    { icon: Clock, text: "New Staff Onboarding Teams" },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Training Designed for Real-World Care Teams</h2>
      ...
      <section className="py-16 px-4">
        <div className="container max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Documentation & Compliance Topics We Teach</h2>
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Flexible, Practical Training That Fits Your Team</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section className="py-16 px-4">
        <div className="container max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Documentation Is Your Legal Lifeline</h2>
      ...
      <section className="py-16 px-4 bg-primary text-primary-foreground">
        <div className="container max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Turn Documentation From a Liability Into a Strength</h2>
