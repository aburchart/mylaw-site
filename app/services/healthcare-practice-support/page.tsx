...
import { Shield, CheckCircle, Users, FileText, AlertTriangle, Stethoscope, UserCheck, Building, Heart, Clipboard } from "lucide-react";
import { BookingCTAButton } from "@/components/ui/booking-cta-button";

export const metadata: Metadata = {
  title: "Healthcare Practice Support",
  description:
    "Legal compliance and risk management for GP clinics, allied health, and specialist centres across Queensland. Protect your licence with proactive healthcare practice support from Brisbane.",
};

export default function HealthcarePracticeSupport() {
  const whoWeHelp = [
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-24 px-4 min-h-[60vh] flex items-center">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/services-care-hero.jpg')" }}>
          <div className="absolute inset-0 bg-gradient-to-br from-primary/80 via-primary/70 to-primary/60" />
        </div>
        <div className="container max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Protect Your License. Keep Patient Care Safe.</h1>
          ...
          <BookingCTAButton size="lg" className="text-lg px-8 py-6">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-lg space-y-6">
            <p>Running a medical practice or allied health service means managing clinical, legal, and regulatory obligations — all while delivering excellent care.</p>
            <p>MyLaw Solutions helps healthcare providers stay ahead of risk. From privacy law to documentation compliance and audit response, we simplify the complex legal landscape so you can focus on your patients, not paperwork.</p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">What We Support You With</h2>
      ...
      <section className="container mx-auto px-4 py-16 bg-muted/50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Why Clinics Reach Out</h2>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Support That Speaks Your Language (Not Legalese)</h2>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Let's Make Compliance a Team Sport</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <BookingCTAButton size="lg" className="text-lg px-8">Book a Call</BookingCTAButton>
