...
export const metadata: Metadata = {
  ...
  description:
    "NDIS compliance advisory for Queensland providers. Stay accredited, prepare for NDIS Commission audits, and protect participant funding with expert legal support in Brisbane.",
};

export default function NDISComplianceAdvisory() {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 bg-primary text-primary-foreground">
        <div className="container max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Let's Get Your NDIS House in Order</h2>
