...
export const metadata: Metadata = {
  ...
  description:
    "Urgent audit and regulatory response support for aged care and NDIS providers in Queensland. Respond to ACQSC or NDIS Commission notices quickly and correctly with Brisbane-based legal guidance.",
};

export default function AuditRegulatoryResponse() {
  const triggers = [
    { icon: FileText, text: "Received a formal notice or request for evidence" },
    { icon: Shield, text: "Facing a scheduled or surprise audit" },
    { icon: AlertTriangle, text: "Got a complaint from the ombudsman or a participant" },
    { icon: CheckCircle2, text: "Identified compliance issues during internal review" },
    { icon: Users, text: "Dealing with clinical issues due to inadequate clinical documentation or recordkeeping." },
    { icon: Clock, text: "Unsure how to respond to regulator timelines" },
  ];
  const services = [
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-24 px-4 min-h-[60vh] flex items-center">
        ...
        <div className="container max-w-4xl mx-auto text-center relative z-10">
          ...
          <BookingCTAButton size="lg" className="shadow-professional">
            Book a Compliance Call
          </BookingCTAButton>
          <p className="text-sm text-white/80 mt-4">Same-day response guaranteed</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Are You Dealing With Any of These?</h2>
      ...
      <section className="py-16 px-4">
        <div className="container max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">How We Support You During a Regulator Response</h2>
        ...
        <div className="container max-w-4xl mx-auto">
          <Card className="border-2 border-primary/20 shadow-lg">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl mb-2">Free Checklist: 5 Things to Do When You Get an Audit Notice</CardTitle>
      ...
      <section className="py-16 px-4 bg-primary text-primary-foreground">
        <div className="container max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Let's Take the Stress Out of Your Next Audit</h2>
          ...
          <p className="text-sm mt-6 opacity-75">Serving Brisbane & Queensland providers</p>
        </div>
      </section>
