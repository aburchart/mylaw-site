...
export const metadata: Metadata = {
  ...
  description:
    "You've subscribed to MyLaw Solutions compliance updates. Book a free consultation and download our free resources for aged care, NDIS, and healthcare providers in Queensland.",
};
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Check your inbox for a welcome message with links to our most popular resources.</CardDescription>
                </CardHeader>
              </Card>
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Monthly Updates</CardTitle>
                  <CardDescription>Receive curated compliance tips and legal insights delivered straight to your inbox.</CardDescription>
                </CardHeader>
              </Card>
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Exclusive Content</CardTitle>
                  <CardDescription>Get early access to new guides, checklists, and training materials.</CardDescription>
                </CardHeader>
              </Card>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-muted-foreground mb-8">Book a free consultation to discuss your specific compliance needs</p>
            <BookingEmbed />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-muted-foreground mb-12">Download these popular resources to get started right away</p>
            <div className="grid md:grid-cols-2 gap-6">
              {recommendedResources.map((resource, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <DownloadButton downloadUrl={resource.downloadUrl} className="w-full" variant="outline">
                      Download Now
                    </DownloadButton>
                  </CardContent>
                </Card>
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Need Immediate Support?</h2>
