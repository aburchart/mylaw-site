...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Book a compliance call with Myla Ruttan in Brisbane. Same-day confirmations available. Free 15-minute consultation for aged care, NDIS, and healthcare providers across Queensland.",
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          ...
          <Script src="https://link.burkstreet.com/js/form_embed.js" strategy="afterInteractive" />
        </section>
